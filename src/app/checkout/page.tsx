...
function CheckOut() {
  ...
  return (
    <div className='w-full min-h-screen h-fit flex flex-col justify-center items-center mt-16'>
        ...
        <div className='space-y-4 text-center my-4'>
          ...
          <div className='flex justify-center item-center'>
            <button
              ...
              className='block  rounded bg-gray-800 px-20 py-4 font-normal text-white hover:bg-yellow-700'
            >
              Checkout
            </button> </div>
          <Link
...
//               <li
//                 key={index}
//                 className='flex flex-row border-b-2 py-4 border-gray-200'
//               >
...
//                       height={300}
//                       width={300}
//                       className='aspect-square md:h-20 h-16 w-20  rounded-xl object-cover'
//                     />
//                   </div>
//                   <div className='m-2'>
//                     <h3 className='text-sm text-gray-900'>{item.title}</h3>
