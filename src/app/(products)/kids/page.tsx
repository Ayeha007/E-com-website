...
export default async function Kids() {
  ...
  return (
    <section id="kids" className="mt-8">
      ...
      style={{
        backgroundImage: `url('kid8.jpg')`,
      }}>
        <p className='flex justify-center item-center lg:font-bold font-normal lg:text-4xl text-lg text-amber-400 '> Kid&apos;s Collection</p>
        </div>
